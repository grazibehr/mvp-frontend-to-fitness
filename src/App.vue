...
<template>
  <div :class="{ 'dark': themeStore.isDark }" class="min-h-screen">
    ...
    <main class="min-h-screen bg-background-light dark:bg-background-dark transition-colors duration-200 main-content"
          :class="{ 'lg:ml-64': authStore.isAuthenticated && showNavigation }">
